class CreateEseqFlowcell < ActiveRecord::Migration[7.0]
  def change
    create_table :eseq_flowcell, id: false, options: 'CHARSET=utf8 COLLATE=utf8_unicode_ci' do |t|
      ...
      t.string :id_flowcell_lims, limit: 255, null: false, comment: 'LIMs-specific flowcell id'
      ...
      t.string :id_flowcell_lims, limit:20, null: false, comment: 'LIMs-specific flowcell id, batch_id for Sequencescape', index: true
