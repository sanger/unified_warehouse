  ...
  def up
    ...
    ViewsSchema.create_view(
      ...
      <<~SQL.squish
        ...
        mlwh_stock_resource.labware_coordinate AS "coordinate", mlwh_sample.created AS "created", "Tecan" as "robot_type"
        ...
        mlwh_lh_sample.coordinate AS "coordinate", mlwh_sample.created AS "created", "Beckman" as "robot_type"
        FROM #{mlwh_wh_db}.sample as mlwh_sample
