...
class AddCherrypickedSamplesView < ActiveRecord::Migration[6.0]
  def up
    ...
    execute <<-SQL.squish
      ...
      SELECT root_sample_id, plate_barcode, phenotype, coordinate, created
      FROM (
      ...
      GROUP BY cp_sample.root_sample_id, cp_sample.plate_barcode, cp_sample.phenotype, cp_sample.coordinate, cp_sample.created
    SQL
  end
