class AddCommentsTable < ActiveRecord::Migration[7.2]
  def change
    create_table :comments do |t|
      ...
      t.integer :position, null: false, limit: 2, unsigned: true, comment: 'Position of the lane in the flowcell'
      t.integer :tag_index, null: false, limit: 2, unsigned: true, comment: 'Index of the tag (check iseq_flowcell tag_index column)'
