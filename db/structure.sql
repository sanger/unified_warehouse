...
--
-- Table structure for table `lighthouse_samples`
--

DROP TABLE IF EXISTS `lighthouse_samples`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `lighthouse_samples` (
  `id` int NOT NULL AUTO_INCREMENT,
  `mongodb_id` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Auto-generated id from MongoDB',
  `root_sample_id` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Id for this sample provided by the Lighthouse lab',
  ...
  `rna_id` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Lighthouse lab-provided id made up of plate barcode and well',
  ...
  `result` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Covid-19 test result from the Lighthouse lab',
  ...
  `updated_at` datetime DEFAULT NULL COMMENT 'When this record was most last updated',
  PRIMARY KEY (`id`),
  UNIQUE KEY `index_lighthouse_samples_on_root_sample_id_and_rna_id_and_result` (`root_sample_id`,`rna_id`,`result`),
  UNIQUE KEY `index_lighthouse_samples_on_mongodb_id` (`mongodb_id`),
  KEY `index_lighthouse_samples_on_date_tested` (`date_tested`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
