...
--
-- Table structure for table `samples_extraction_activity`
--
...
CREATE TABLE `samples_extraction_activity` (
  `id_oseq_flowcell_tmp` int NOT NULL AUTO_INCREMENT,
  `id_activity_lims` varchar(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'LIMs-specific activity id',
  `id_sample_tmp` int unsigned NOT NULL COMMENT 'Sample id, see "sample.id_sample_tmp"',
  `activity_type` varchar(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'The type of the activity performed',
  `instrument` varchar(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'The name of the instrument used to perform the activity',
  `kit_barcode` varchar(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'The barcode of the kit used to perform the activity',
  `kit_type` varchar(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'The type of kit used to perform the activity',
  `input_barcode` varchar(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'The barcode of the labware (eg. plate or tube) at the begining of the activity',
  `output_barcode` varchar(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'The barcode of the labware (eg. plate or tube)  at the end of the activity',
  `user` varchar(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'The name of the user who was most recently associated with the activity',
...
-- Dump completed on 2020-10-28 11:51:54
...
INSERT INTO schema_migrations (version) VALUES ('20201028091922');
