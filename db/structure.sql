...
--
-- Table structure for table `cgap_heron`
--

DROP TABLE IF EXISTS `cgap_heron`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `cgap_heron` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `tube_rack_barcode` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `tube_barcode` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `supplier_sample_id` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `position` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `last_updated` datetime NOT NULL COMMENT 'Timestamp of last update',
  `recorded_at` datetime NOT NULL COMMENT 'Timestamp of warehouse update',
  PRIMARY KEY (`id`),
  UNIQUE KEY `index_cgap_heron_on_tube_barcode` (`tube_barcode`),
  UNIQUE KEY `index_cgap_heron_on_tube_rack_barcode_and_position` (`tube_rack_barcode`,`position`),
  KEY `index_cgap_heron_on_supplier_sample_id` (`supplier_sample_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `iseq_flowcell` (
  ...
  `id_lims` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'LIM system identifier, e.g. CLARITY-GCLP, SEQSCAPE',
  `priority` smallint(5) unsigned DEFAULT '1' COMMENT 'Priority',
  ...
  `position` smallint(5) unsigned NOT NULL COMMENT 'Flowcell lane number',
  ...
  `requested_insert_size_from` int(10) unsigned DEFAULT NULL COMMENT 'Requested insert size min value',
  `requested_insert_size_to` int(10) unsigned DEFAULT NULL COMMENT 'Requested insert size max value',
  `forward_read_length` smallint(5) unsigned DEFAULT NULL COMMENT 'Requested forward read length, bp',
  `reverse_read_length` smallint(5) unsigned DEFAULT NULL COMMENT 'Requested reverse read length, bp',
...
CREATE TABLE `oseq_flowcell` (
  ...
  `pipeline_id_lims` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'LIMs-specific pipeline identifier that unambiguously defines library type',
  `requested_data_type` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'The type of data produces by sequencing, eg. basecalls only',
...
-- Dump completed on 2020-03-20 10:17:36
...
INSERT INTO schema_migrations (version) VALUES ('20200318151832');
