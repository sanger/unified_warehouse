...
CREATE TABLE `pac_bio_run` (
  ...
  `tag2_sequence` varchar(30) COLLATE utf8_unicode_ci DEFAULT NULL,
  `tag2_set_id_lims` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL,
  `tag2_set_name` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
  `tag2_identifier` varchar(30) COLLATE utf8_unicode_ci DEFAULT NULL,
