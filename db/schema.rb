...
ActiveRecord::Schema.define(version: 2021_02_10_231042) do
  ...
  create_table "lighthouse_sample", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci", force: :cascade do |t|
