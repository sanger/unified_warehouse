...
ActiveRecord::Schema[7.2].define(version: 2026_06_26_140704) do
  create_table "aliquot", charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
    ...
    t.string "sample_name", limit: 512, null: false, comment: "The name of the sample that the aliquot was created from"
