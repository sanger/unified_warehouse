...
ActiveRecord::Schema[8.1].define(version: 2026_09_16_125342) do
  ...
  create_table "lighthouse_sample", id: :integer, charset: "utf8mb3", collation: "utf8mb3_unicode_ci", options: "ENGINE=InnoDB ROW_FORMAT=DYNAMIC", force: :cascade do |t|
    ...
    t.integer "cog_uk_id_unique", limit: 1, default: 1, comment: "A flag to indicate cog_uk_id should be unique. NULL allows reuse of the ID in another row."
    ...
    t.index ["cog_uk_id", "cog_uk_id_unique"], name: "index_lighthouse_sample_on_cog_uk_id_and_cog_uk_id_unique", unique: true
  ...
  create_table "study", primary_key: "id_study_tmp", id: { type: :integer, unsigned: true }, charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
    ...
    t.string "data_release_prevention_reason", comment: "Reason for preventing data release for this study"
    ...
    t.boolean "is_current", default: true, comment: "Indicates if this study is the current version"
    t.datetime "last_updated", precision: nil, null: false, comment: "Timestamp of last update"
    t.string "name"
  ...
  create_table "useq_wafer", primary_key: "id_useq_wafer_tmp", id: { type: :integer, comment: "Internal to this database, id value can change", unsigned: true }, charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
    ...
    t.string "converted_illumina_tag_sequence", comment: "Illumina tag sequence used"
    ...
    t.string "tag_sequence", limit: 30, comment: "Tag sequence"
    t.string "uga_primer", comment: "UGA indexing primer (Forward/R1 side)"
    t.string "ugb_primer", comment: "UGB indexing primer (Reverse/R2 side)"
