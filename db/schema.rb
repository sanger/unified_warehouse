...
ActiveRecord::Schema[7.0].define(version: 2023_06_05_152453) do
  create_table "bmap_flowcell", primary_key: "id_bmap_flowcell_tmp", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
  ...
  create_table "flgen_plate", primary_key: "id_flgen_plate_tmp", id: { type: :integer, unsigned: true }, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.integer "id_sample_tmp", null: false, comment: "Sample id, see \"sample.id_sample_tmp\"", unsigned: true
    t.integer "id_study_tmp", null: false, comment: "Study id, see \"study.id_study_tmp\"", unsigned: true
  ...
  create_table "iseq_flowcell", primary_key: "id_iseq_flowcell_tmp", id: { type: :integer, unsigned: true }, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.datetime "last_updated", precision: nil, null: false, comment: "Timestamp of last update"
    t.datetime "recorded_at", precision: nil, null: false, comment: "Timestamp of warehouse update"
    t.integer "id_sample_tmp", null: false, comment: "Sample id, see \"sample.id_sample_tmp\"", unsigned: true
  ...
  create_table "lighthouse_sample", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
  ...
  create_table "long_read_qc_result", primary_key: "id_long_read_qc_result_tmp", charset: "utf8", force: :cascade do |t|
  ...
  create_table "oseq_flowcell", primary_key: "id_oseq_flowcell_tmp", id: { type: :integer, unsigned: true }, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.string "id_flowcell_lims", null: false, comment: "LIMs-specific flowcell id"
    t.datetime "last_updated", precision: nil, null: false, comment: "Timestamp of last update"
    t.datetime "recorded_at", precision: nil, null: false, comment: "Timestamp of warehouse update"
    t.integer "id_sample_tmp", null: false, comment: "Sample id, see \"sample.id_sample_tmp\"", unsigned: true
  ...
  create_table "pac_bio_run", primary_key: "id_pac_bio_tmp", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.datetime "last_updated", precision: nil, null: false, comment: "Timestamp of last update"
    t.datetime "recorded_at", precision: nil, null: false, comment: "Timestamp of warehouse update"
    t.integer "id_sample_tmp", null: false, comment: "Sample id, see \"sample.id_sample_tmp\"", unsigned: true
  ...
  create_table "psd_sample_compounds_components", charset: "utf8", comment: "A join table owned by PSD to associate compound samples with their component samples.", force: :cascade do |t|
  ...
  create_table "qc_result", primary_key: "id_qc_result_tmp", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
  ...
  create_table "sample", primary_key: "id_sample_tmp", id: { type: :integer, unsigned: true }, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.string "id_lims", limit: 10, null: false, comment: "LIM system identifier, e.g. CLARITY-GCLP, SEQSCAPE"
  ...
  create_table "samples_extraction_activity", primary_key: "id_activity_tmp", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
  ...
  create_table "stock_resource", primary_key: "id_stock_resource_tmp", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.datetime "last_updated", precision: nil, null: false, comment: "Timestamp of last update"
    t.datetime "recorded_at", precision: nil, null: false, comment: "Timestamp of warehouse update"
  ...
  create_table "study", primary_key: "id_study_tmp", id: { type: :integer, unsigned: true }, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
  ...
  create_table "study_users", primary_key: "id_study_users_tmp", id: { type: :integer, unsigned: true }, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.integer "id_study_tmp", null: false, comment: "Study id, see \"study.id_study_tmp\"", unsigned: true
    t.datetime "last_updated", precision: nil, null: false, comment: "Timestamp of last update"
    t.string "role"
    t.string "login"
