...
ActiveRecord::Schema.define(version: 2022_09_15_104006) do
  ...
  create_table "lighthouse_sample", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci", force: :cascade do |t|
